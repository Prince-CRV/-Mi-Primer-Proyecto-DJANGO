        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="#" rel="edit" class="btn btn-outline-warning btn-flat btnEdit"><i class="fa-solid fa-pen-to-square"></i></a> ';
                    buttons += '<a href="#" type="button" class="btn btn-outline-danger btn-flat"><i class="fa-solid fa-trash"></i></a>';
                    return buttons;
                }
            },
        ],
